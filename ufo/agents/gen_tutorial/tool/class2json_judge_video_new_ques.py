...
class EvaluationScores(BaseModel):
    ...
    """
    usability: ScoreWithReason
    correctness: ScoreWithReason
    interactivity: ScoreWithReason
    design_quality: ScoreWithReason
    transferability: ScoreWithReason
    completion_satisfaction: ScoreWithReason
    efficiency_preference: ScoreWithReason
...
if __name__ == "__main__":
    ...
    file_path = "../data/steps_schema_questionnaire_score_video.json"
