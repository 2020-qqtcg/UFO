...
def process_and_evaluate_steps_object(root_directory, model_name,schema):
    ...
    for root, dirs, files in os.walk(root_directory):
        ...
        if 'document_step.json' in files:
            ...
            if os.path.basename(root) == 'document_cost':
...
if __name__ == '__main__':
    ...
    # root_folder = r"C:\Users\v-yuhangxie\OneDrive - Microsoft\uiagent_result_gpt5\qabench_completion_double"
    root_folder = r"C:\Users\v-yuhangxie\OneDrive - Microsoft\uiagent_result_gpt5\m365_completion_double"
    root_folder =r"C:\Users\v-yuhangxie\OneDrive - Microsoft\uiagent_result\20250725_bing_4.1_cost_complete_double"
